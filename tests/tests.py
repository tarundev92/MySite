...
class PollsTest(LiveServerTestCase):
    ...
    def test_can_create_new_poll_via_admin_site(self):
        ...
        password_field.send_keys('mysite123')
        ...
        polls_links = self.browser.find_elements_by_link_text('Questions')
        ...
        save_button = self.browser.find_element_by_xpath("//input[@name='_save'][@value='Save']")
        save_button.click()
